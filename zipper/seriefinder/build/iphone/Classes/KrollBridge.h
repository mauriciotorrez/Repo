...
@interface seriefinderObject : KrollCoverageObject {
#else
@interface seriefinderObject : KrollObject {
#endif
@private
...
extern NSString * seriefinder$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	seriefinderObject *_seriefinder;
    KrollObject* console;
	BOOL shutdown;
