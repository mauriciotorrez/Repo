...
/**
 Base class for all seriefinder views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the seriefinder view hierarchy (such as wrapped iOS UIViews) was touched.
