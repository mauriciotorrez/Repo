...
/**
 The base class for all seriefinder modules
 */
...
/**
 seriefinder Platform calls this method on startup.
 */
-(void)startup;

/**
 seriefinder Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 seriefinder Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 seriefinder Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 seriefinder Platform calls this method on resume.
 @param sender The sender of the event.
 */
