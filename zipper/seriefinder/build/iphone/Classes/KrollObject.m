...
//@interface seriefinderObject : NSObject
//@end

@interface seriefinderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[seriefinderObject class]])
		{
			for (NSString *key in [[(seriefinderObject*)o modules] allKeys])
			{
