...
// in simulator we redefine to format for seriefinder Developer console
...
{\
	NSString * exceptionName = [@"org.seriefinder." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.seriefinder";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIseriefinderNativeItemNone = -1, 
	UIseriefinderNativeItemSpinner = -2,
	UIseriefinderNativeItemProgressBar = -3,
	
	UIseriefinderNativeItemSlider = -4,
	UIseriefinderNativeItemSwitch = -5,
	UIseriefinderNativeItemMultiButton = -6,
	UIseriefinderNativeItemSegmented = -7,
	
	UIseriefinderNativeItemTextView = -8,
	UIseriefinderNativeItemTextField = -9,
	UIseriefinderNativeItemSearchBar = -10,
	
	UIseriefinderNativeItemPicker = -11,
	UIseriefinderNativeItemDatePicker = -12,
	
	UIseriefinderNativeItemInfoLight = -13,
	UIseriefinderNativeItemInfoDark = -14,
	
	UIseriefinderNativeItemDisclosure = -15,
	
	UIseriefinderNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all seriefinder instances of
